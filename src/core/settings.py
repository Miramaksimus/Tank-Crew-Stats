...
Updated for Django 5.2 LTS compatibility.
...
# Default primary key field for models
...
# Use default storage for development, manifest storage requires collectstatic
