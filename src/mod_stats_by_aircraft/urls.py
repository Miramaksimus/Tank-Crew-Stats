...
urlpatterns = [
    ...
    re_path(r'^all_aircraft/$', views.all_aircraft, name='all_aircraft'),
    re_path(r'^all_aircraft/(?P<airfilter>\S+)/$', views.all_aircraft, name='all_aircraft'),
    re_path(r'^aircraft/(?P<aircraft_id>\d+)/(?P<airfilter>\S+)/$', views.aircraft, name='aircraft'),
    re_path(r'^aircraft_killboard/(?P<aircraft_id>\d+)/(?P<airfilter>\S+)/$', views.aircraft_killboard,
        name='aircraft_killboard'),
    re_path(r'^aircraft_pilot_rankings/(?P<aircraft_id>\d+)/(?P<airfilter>\S+)/$', views.aircraft_pilot_rankings,
        name='aircraft_pilot_rankings'),

    re_path(r'^aircraft_overview/(?P<profile_id>\d+)/(?P<nickname>\S+)/(?P<airfilter>\S+)/$', views.pilot_aircraft_overview,
        name='pilot_aircraft_overview'),
    re_path(r'^pilot_aircraft/(?P<aircraft_id>\d+)/(?P<airfilter>\S+)/(?P<profile_id>\d+)/(?P<nickname>\S+)/$',
        views.pilot_aircraft, name='pilot_aircraft'),
    re_path(r'^pilot_aircraft_killboard/(?P<aircraft_id>\d+)/(?P<airfilter>\S+)/(?P<profile_id>\d+)/(?P<nickname>\S+)/$',
        views.pilot_aircraft_killboard, name='pilot_aircraft_killboard'),
    re_path(r'^download_ammo_breakdown_csv/(?P<ammo_key>\S+)/(?P<breakdown_type>\S+)/(?P<bucket_id>\d+)/$',
    ...
    re_path(r'^tankman_killboard/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.tankman_killboard,
...
if hasattr(views, 'ironman_stats'):  # For compatibility with mod_rating_by_type.
    urlpatterns.append(re_path(r'^ironman/$', views.ironman_stats, name='ironman'))
    urlpatterns.append(re_path(r'^mission_ironman', views.mission_ironman, name='mission_ironman'))
    urlpatterns.append(re_path(r'^mission_vlife/(?P<vlife_id>\d+)/$', views.mission_vlife, name='mission_vlife'))
    urlpatterns.append(re_path(r'^mission_ironman', views.mission_ironman, name='mission_ironman'))
    urlpatterns.append(re_path(r'^mission_vlife/(?P<vlife_id>\d+)/$', views.mission_vlife, name='mission_vlife'))
    urlpatterns.append(re_path(r'^gunners/$', views.gunners, name='gunners'))
    urlpatterns.append(re_path(r'^gunner/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner, name='gunner'))
    urlpatterns.append(re_path(r'^gunner_sortie/(?P<sortie_id>\d+)/$', views.gunner_sortie, name='gunner_sortie'))
    urlpatterns.append(re_path(r'^gunner_sortie/log/(?P<sortie_id>\d+)/$', views.gunner_sortie_log, name='gunner_sortie_log'))
    urlpatterns.append(re_path(r'^gunner_vlife/(?P<vlife_id>\d+)/$', views.gunner_vlife, name='gunner_vlife'))
    urlpatterns.append(re_path(r'^gunner_vlifes/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_vlifes, name='gunner_vlifes'))
    urlpatterns.append(re_path(r'^gunner_awards/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_awards, name='gunner_awards'))
    urlpatterns.append(re_path(r'^gunner_killboard/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_killboard, name='gunner_killboard'))
    urlpatterns.append(re_path(r'^gunner_sorties/(?P<profile_id>\d+)/$', views.gunner_sorties, name='gunner_sorties'))
    urlpatterns.append(re_path(r'^gunner_sorties/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_sorties, name='gunner_sorties'))
