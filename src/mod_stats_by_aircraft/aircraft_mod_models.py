...
class AircraftBucket(models.Model):
    ...
    killboard_planes = models.JSONField(default=dict)
    killboard_ground = models.JSONField(default=dict)
    COALITIONS = (
    ...
    ammo_breakdown = models.JSONField(default=default_ammo_breakdown)
