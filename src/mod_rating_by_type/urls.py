...
urlpatterns = [
    ...
    re_path(r'^gunner/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner, name='gunner'),
    re_path(r'^gunner_sortie/(?P<sortie_id>\d+)/$', views.gunner_sortie, name='gunner_sortie'),
    re_path(r'^gunner_sortie/log/(?P<sortie_id>\d+)/$', views.gunner_sortie_log, name='gunner_sortie_log'),
    re_path(r'^gunner_sorties/(?P<profile_id>\d+)/$', views.gunner_sorties, name='gunner_sorties'),
    re_path(r'^gunner_sorties/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_sorties, name='gunner_sorties'),
    re_path(r'^gunner_vlife/(?P<vlife_id>\d+)/$', views.gunner_vlife, name='gunner_vlife'),
    re_path(r'^gunner_vlifes/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_vlifes, name='gunner_vlifes'),
    re_path(r'^gunner_awards/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_awards, name='gunner_awards'),
    re_path(r'^gunner_killboard/(?P<profile_id>\d+)/(?P<nickname>\S+)/$', views.gunner_killboard, name='gunner_killboard'),
]
